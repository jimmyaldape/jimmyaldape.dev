...
<div class="flex flex-col min-h-screen">
    <header class="block flex justify-between w-full p-10 pb-0 z-50">
        <div class="flex">
    ...
    <main class="flex flex-grow justify-center text-center container h-full max-w-6xl p-10 mx-auto @yield('offset')">
        @yield('body')
    </main>
