...
<html lang="{{ $page->language ?? 'en' }}">
    ...
    <body>
        <div class="min-w-screen min-h-screen bg-gray-800 flex items-center justify-center px-5 py-5 relative text-white">
            ...
            <div class="flex justify-between top-0 right-0 mt-6 mr-10 absolute">
                <div class="hover:text-blue-300"><a href="{{'/blog'}}">blog</a></div>
                <div class="pl-4">
                    <a class="hover:text-blue-300" href="#" target="_blank" title="View jimmy aldape's current resume">
                        resume
                    </a>
                </div>
                <div class="pl-4">
                    <a class="hover:text-blue-300" href="https://twitter.com/jimmyaldape" target="_blank" title="Follow jimmy aldape on twitter">
                        twitter
                    </a>
                </div>
                <div class="pl-4">
                    <a class="hover:text-blue-300" href="https://www.linkedin.com/in/jimmyaldape/" target="_blank" title="Connect with jimmy aldape on linkedin">
                        linkedin
                    </a>
                </div>
            </div>
            @yield('body')
            <footer class="absolute bottom-0 mb-4 text-xs text-gray-600">&copy {{ date('Y') }} Jimmy Aldape. Made with <a class="text-gray-500 hover:underline" href="https://jigsaw.tighten.co/" title="Visit jigsaw.tighten.co">Jigsaw</a> and <a class="text-gray-500 hover:underline" href="https://tailwindcss.com/" title="Visit tailwindcss.com">Tailwind CSS</a></footer>
        </div>
    </body>
</html>
