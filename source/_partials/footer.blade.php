<div class="mb-6 flex justify-between gap-4 mx-auto">
    <a href="https://twitter.com/jimmyaldape" target="_blank" title="visit Jimmy Aldape on twitter" class="text-gray-500 hover:text-green-600">
    ...
    <a href="https://www.linkedin.com/in/jimmyaldape" target="_blank" title="visit Jimmy Aldape on linkedin" class="text-gray-500 hover:text-green-600">
        <svg class="h-8 w-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75.93 75.93">
    ...
    <a href="https://github.com/jimmyaldape" target="_blank" title="view a sample of Jimmy Aldape's projects on github" class=" text-gray-500 hover:text-green-600">
